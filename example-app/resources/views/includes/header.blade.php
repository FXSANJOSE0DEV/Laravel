...
{{--    <p>Et c'est pareil pour le casque. Eh oui on n'oublie pas, le port de la bombe est obligatoire ! Pour le reste par--}}
{{--        contre, c'est une question de goût. Alors, plutôt bottes ou boots avec des chaps ?</p>--}}
{{--    <div class="main">--}}
