    ...
    <main class="global">
        ...
        <section class="section2" id="Hébergements">
            <div class="content1">
                ...
                <div class="card">
                    <img class="img" src="../../public/assets/images/produits/7.jpg" alt="Pantalon d'équitation">
                ...
                <div class="card">
                    <img class="img" src="images/produits/image-2.jpg" alt="Pantalon d'équitation">
                    <h4 class="information"><a href="#">Pantalon d'équitation</a></h4>
                ...
                <div class="card">
                    <img class="img" src="images/produits/image6.jpg" alt="Pantalon d'équitation">
                    <h4 class="information"><a href="#">Pantalon d'équitation</a></h4>
                ...
                <div class="card">
                    <img class="img" src="images/produits/img6.jpg" alt="Pantalon d'équitation">
                    <h4 class="information"><a href="#">Pantalon d'équitation</a></h4>
                ...
                <div class="card">
                    <img class="img" src="images/produits/image3.jpg" alt="Pantalon d'équitation">
                    <h4 class="information"><a href="#">Pantalon d'équitation</a></h4>
                ...
                <div class="card">
                    <img class="img" src="images/produits/etrier.jpg" alt="Pantalon d'équitation">
                    <h4 class="information"><a href="#">Pantalon d'équitation</a></h4>
            ...
            <div class="content2">
                ...
                <div class="item">
                    <img src="images/produits/gpa.jpg" alt="Bombe">
                ...
                <div class="item">
                    <img src="images/produits/selle western.jpg" alt="selle-Western">
                    <div class="item-infos">
                ...
                <div class="item">
                    <img src="images/produits/tapis ronzon.png" alt="Hôtel Tout bleu est Blanc">
                    <div class="item-infos">
        ...
        <section class="section3" id="Activites">
            <div class="activites">
                <div class="global1">
                    <div class="acti1">
                        <img src="images/produits/produit anti-mouch.jpg" alt="Produit anti-mouches">
                        <h3>
                    ...
                    <div class="acti2">
                        <div class="acti_item" id="activite2">
                            <img src="images/produits/masque-anti-mouche.jpg" alt="Anti-mouches">
                            <h3><a href="#">Anti-mouches</a> </h3>
                        </div>
                        <div class="acti_item2" id="activite3">
                            <img src="images/produits/saide poull.jpg" alt="Side-pull">
                            <h3>
                                <a href="#">Side-pull</a>
                            </h3>
                        </div>
                ...
                <div class="global2">
                    <div class="acti1">
                        <img src="images/produits/etrier.jpg" alt="ETRIERS">
                        <h3>
                            <a href="#">ETRIERS</a>
                        </h3>
                    </div>
